...
import { JAVA_ARTICLES, ANGULAR_ARTICLES, FAVORITE_ARTICLES } from '../models/article';
...
const _articleReducer = createReducer(
    ...
    on(fromActions.FavoriteArticlesAction, (state) => { return { articles: FAVORITE_ARTICLES }; })
);
